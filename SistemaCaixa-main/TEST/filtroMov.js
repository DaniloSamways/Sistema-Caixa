function getMovimentos(url, dataInicial, dataFinal){
    let request = new XMLHttpRequest();
    request.open('GET', url + "?dataInicial=" + dataInicial +"&dataFinal=" + dataFinal, false)
    request.send();
...
function mainFiltro(dataInicial, dataFinal){
    let data = getMovimentos('http://localhost:3000/API/movimentos/filtro', dataInicial, dataFinal);
